...
--
myWorkspaces    = ["web","con","code","mail","msg","irc","snd"] ++ map show [1..3]
...
myLayout = defaultTiled 

{-- onWorkspace "web" (Full ||| defaultTiled)
	 $ onWorkspace "con" (Full ||| defaultTiled)
	 $ onWorkspace "code" (Full ||| defaultTiled)
	 $ onWorkspace "mail" (Full ||| defaultTiled)
	 $ onWorkspace "msg" (Full ||| defaultTiled)
	 $ onWorkspace "irc" (Full ||| defaultTiled)
	 $ onWorkspace "snd" (Full ||| defaultTiled)
--}
-- ["web","con","code","mail","msg","irc","snd"]
------------------------------------------------------------------------
-- Window rules:
...
--
main = do
  xmproc <- spawnPipe "/usr/bin/xmobar /home/at/.xmobarrc"
  spawner <- mkSpawner
